...
import com.android.systemui.aim.ImageUtilities;
...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    private AimObserver mAimObserver = new AimObserver(mHandler);
    private class AimObserver extends ContentObserver {
        AimObserver(Handler handler) {
            super(handler);
        }
         void observe() {
